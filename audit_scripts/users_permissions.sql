...
set termout on
prompt --audit_results/cdb_users.csv
set termout off
...
set termout on
prompt --audit_results/cdb_profiles.csv
set termout off
...
set termout on
prompt --audit_results/cdb_roles.csv
set termout off
...
set termout on
prompt --audit_results/cdb_sys_privs.csv
set termout off
...
set termout on
prompt --audit_results/cdb_tab_privs.csv
set termout off
...
set termout on
prompt --audit_results/cdb_role_privs.csv
set termout off
...
set termout on
prompt --audit_results/role_role_privs.csv
set termout off
...
set termout on
prompt --audit_results/role_tab_privs.csv
set termout off
...
set termout on
prompt --audit_results/role_sys_privs.csv
set termout off
...
set termout on
prompt --audit_results/user_effective_privs.csv
set termout off
...
set termout on
prompt --audit_results/users_and_roles.csv
set termout off
